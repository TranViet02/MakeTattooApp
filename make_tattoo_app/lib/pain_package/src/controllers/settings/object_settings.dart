...
import 'package:flutter/material.dart'; // Đảm bảo rằng bạn đã thêm package flutter/material.dart vào dependencies
...
class ObjectSettings {
  ...
  const ObjectSettings({
    ...
    this.showScaleRotationControlsResolver = _alwaysShowScaleRotationControls,
  });
  ...
  /// Default value for [showScaleRotationControlsResolver].
  ///
  /// Always returns `true`, so scale and rotation controls are always shown.
  static bool _alwaysShowScaleRotationControls() {
    return true;
  }
}
